...
class DataEntry:
    def __init__(self):
        ...
        self.user_info_frame.grid(row=0, column=0, sticky='NW')
        ...
        # Saving Course Info
        self.courses_frame_font = ttk.Label(text="Main", font=24)
        self.courses_frame = ttk.LabelFrame(self.window, labelwidget=self.courses_frame_font)
        self.courses_frame.grid(row=1, column=0, sticky='w')
        ...
        self.terms_frame.grid(row=2, column=0, sticky='nwes')
